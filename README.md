...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/cad_to_dagmc-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/cad_to_dagmc-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add cad_to_dagmc
# for installing globally
pixi global install cad_to_dagmc
```
...
It is possible to list all of the versions of `cad_to_dagmc` available on your platform:
...
```
pixi search cad_to_dagmc --channel conda-forge
```
